# Ce script permet d'écrire dans une liste les charges des données réelles en appliquant le veto
...
for i in range(n_files):
    t_prev = 0
    outfile = open(f"/storage/gpfs_data/juno/junofs/users/frosso/out/{run}/out_data_veto2_run{run}_file{i+1}.txt", "w")
    ...
    weight = 1/t_data
    print(run, weight, "veto2", file=outfile)
    outfile.close()
