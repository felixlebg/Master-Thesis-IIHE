# Ce script permet d'écrire dans une liste les charges des simulations ccs en appliquant le veto 2
...
for i in range(n_files):
    outfile = open(f"/storage/gpfs_data/juno/junofs/users/frosso/out/simu/{filling}/out_simu_veto2_file{i+1}.txt", "w")
    ...
    print("simu", weight, "veto2", file=outfile)
    outfile.close()
